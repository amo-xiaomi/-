...
<div id="newUserModal" class="modal hide fade">
	...
	<div class="modal-body">
		<form class="form-horizontal" action="insert.product"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input id="np" name="normalprice" type="text" placeholder="普通价格"
						onblur="price()" />
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input id="mp" type="text" name="memberprice" placeholder="会员价格" />
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input id="img" type="file" placeholder="商品图片" name="file"/>
				</div>
			</div>
			<div class="control-group">
